...
func main() {
	...
	for _, cmd := range cmds {
		...
		case GetSubscription:
			...
			LOGV.Println("test get sub for ", user)
			if err != nil {
		...
		case AddSubscription:
			...
			LOGV.Println("test add sub for user ", user, " with ", target)
			if err != nil {
		...
		case RemoveSubscription:
			...
			LOGV.Println("test remove sub for user ", user, " with ", target)
			if err != nil {
		...
		case GetTribbles:
			...
			LOGV.Println("test get trib for ", target)
			if err != nil {
		...
		case PostTribble:
			...
			LOGV.Println("test post trib for ", user, " with ", msg)
			if err != nil {
		...
		case GetTribblesBySubscription:
			...
			LOGV.Println("test get trib by sub for ", user)
			if err != nil {
